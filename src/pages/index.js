			...
			>
				<div className='margin-y-5'>
					<div className='container narrow margin-bottom-4'>
						...
						<p>
							With each passing day, designers and developers face increasing
							expectations. To be successful, we're required to master an ever
							widening landscape of technologies.
						</p>
							...
							<div className='backdrop backdrop--fixed align-content-end'>
								...
								<div className='backdrop__cover'>
									<div className='container narrow margin-y-3'>
										...
										<p className='text-shadow'>
											Apply sweeping color themes to pages and components. You
											can also add single colors to specific elements.
										</p>
							...
							<div className='backdrop backdrop--fixed align-content-end'>
								...
								<div className='backdrop__cover'>
									<div className='container narrow margin-y-3'>
										...
										<p className='text-shadow'>
											Content delivered styles use CSS Variables. Redefine
											styles a number of ways without compiling Sass.
										</p>
							...
							<div className='backdrop backdrop--fixed align-content-end'>
								...
								<div className='backdrop__cover'>
									<div className='container narrow margin-y-3'>
										...
										<p className='text-shadow'>
											CSS logical properties and flipped directional icons
											provide needed support for right-to-left languages.
										</p>
					...
					<div className='container narrow margin-y-5'>
						<div className='grid grid--column-2--md gap-3'>
							...
							<a
								className='button button--has-icon width-100 button--outline'
								href='https://www.npmjs.com/package/natura11y'
								target='_blank'
							>
