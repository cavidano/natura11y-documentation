...
The primary navigation component is a complete header menu system. It's made up of four preassigned areas: the *logo*, *global action buttons*, and the *main menu*. The main menu container includes an optional search field.
...
<PrimaryNavigation navClass="primary-nav--inline--lg" />
