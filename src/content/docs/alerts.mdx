...
When modifying alert colors, be sure to check that your colors meet a sufficient <a href="https://webaim.org/resources/contrastchecker/" target="_blank">contrast ratio</a>.

Never rely on color alone to convey meaning. Include a visual icon in alerts for those who experience colors differently.

Include an appropriate <a href="https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Roles/alert_role" target="_blank">*alert role*</a> for assistive technology.
