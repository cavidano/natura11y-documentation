...
<Divider id="font-size-utilities" />
...
<Divider id="text-align-utilities" />
...
<Divider id="text-transform-utilities" />

<TextBlock>

## Text Transform Utilities

Apply <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/text-transform" target="_blank">text-transform</a> property to a selector.
...
<FigureBlock
    ...
    visualExample={(
        <Fragment>
            <p className="text-transform-capitalize margin-bottom-1">text transform capitalize</p>
            <p className="text-transform-uppercase margin-bottom-1">text transform uppercase</p>
            <p className="text-transform-lowercase margin-bottom-1">text transform lowercase</p>
        </Fragment>
    )}
    codeExample={(`
...
<Divider id="text-decoration-utilities" />

<TextBlock>

## Text Decoration Utilities

Apply <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/text-decoration" target="_blank">text-decoration</a> property to a selector.
...
<FigureBlock
    ...
    visualExample={(
        <Fragment>
            <p className="text-decoration-underline margin-bottom-1">Underline</p>
            <p className="text-decoration-line-through margin-bottom-1">Line through</p>
        </Fragment>
    )}
    codeExample={(`
