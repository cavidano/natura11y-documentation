...
<BrowserFrame frameSrc="../../iframe-examples/custom-properties-01.html" />

<TextBlock>

Declared as CSS variables in **natura11y.css**, we have four colors. They are <em>Primary</em>, <em>Secondary</em>, <em>Dark</em>, and <em>Light</em>.
Let's customize their color values with a second stylesheet.

Within the **color-example** directory, create a new directory called **css**. Make a new CSS file and name it
**new-colors.css**. Save it into the **/css** directory.
...
<BrowserFrame frameSrc="../../iframe-examples/custom-properties-02.html" />
...
The following table accounts for all CSS variables within the Natura11y. Pay close attention to scope of each set of variables (noted under each header in the table).
