...
import { cdnCSS, cdnJS, cdnIcons } from '../../mdxVars';
...
If you're not familiar with CSS variables, take time now to <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/Using_CSS_custom_properties" target="_blank">read the MDN web docs</a>. Figure 1 (below) offers a simple example of using a SASS variable and a CSS Variable to achieve the same result.
...
<Divider id="reference-guide-css-variables" />
...
<div className="container narrow margin-y-4">
    <a className="button button--has-icon theme-primary" href="/docs/accessibility">
        <span className="button__text">Accessibility</span>
