...
The article component offers a responsive two or three column layout. Articles include a fixed-width sidebar. 
...
Articles to not use <a href="#1">breakpoint modifiers</a>. Instead, the layout changes from mobile to desktop view at the *large* viewport.  for three column layouts, the layout changes again at the *extra-large* viewport.
