    ...
    <div class="backdrop theme-dark border-radius"> \n
        <div class="backdrop__image"> \n
           ${codeImgPlaceholderBackdrop} \n
            <div class="backdrop__image__credit">
...
The translucent effect of the backdrop is acheived with the use of additional utility classes. Our <a href="/docs/color/#theme-color-utilities">theme color utilities</a> (e.g. `.theme-dark`) provide the background and text color. The <a href="/docs/opacities">opacity utility class</a> (e.g. `.opacity-30`) applied to the backdrop's feature image, allows the background color to show through.
